<?php
	...
	*/
	...
	function crearcurso($nombre, $fecha_inicio, $fecha_final,$descripcion, $ponentes) {
		include ("conexion.php");
	
	$query="INSERT INTO cursos (Id,Nombre,FechaInicio,FechaFin,Descripcion,Ponente) VALUES (null,'".$nombre."','".$fecha_inicio."','".$fecha_final."','".$descripcion."','".$ponentes."')";
