...
<td><a href="mostrardetalles.php?id=<?php echo $row["Id"]; ?>" class="btn btn-dark">Detalles</a>
<td><a href="modificarcurso.php?olo=<?php echo $row["Id"]; ?>" class="btn btn-primary">Modificar</a>
<td><a href="borrar_curso.php?id=<?php echo $row["Id"]; ?>" class="btn btn-danger">Borrar</a>
...
<footer>
<a>Correo coordinador de cursos de extensión: coordcursos@uco.es</a>
</footer>
<footer>
<a>Correo coordinador de recursos: coordrecursos@uco.es</a>
</footer>
