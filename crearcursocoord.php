...
<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <textarea  rows="5" cols="50" class="form-control" id="desc" name="desc" placeholder="Descripción de la tarea" required></textarea>
    <div class="invalid-feedback">Descripción debe ser válida</div>
    </div>
