          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="listarcursos.php">Ver cursos</a>
              </li>
              <li class="nav-item">
...
<?php
                  ...
                  ?>
                     <td><a href="unirseusuario.php?curso=<?php echo $row["Id"];?>" class="btn btn-success">Alta</a></td>
