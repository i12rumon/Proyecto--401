        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="vercursoscoord.php">Cursos</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
              <a class="nav-link" href="borrarcursocoord.php">Borrar curso</a>
              </li>
              <li class="nav-item">
...
<td><a href="mostrarlista.php?id=<?php echo $row["Id"]; ?>" class="btn btn-warning">Lista de espera</a></td>
        </td>
</tr>
