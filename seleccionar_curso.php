      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item">
                <a class="nav-link" href="menu-coordrecursos.php">Home</a>
              </li> 
              <li class="nav-item active">
                <a class="nav-link" href="asignarrecursos.php">Asignar recursos</a>
              </li> 
              <li class="nav-item">
...
<td><a href="asignarrecursos.php?olo=<?php echo $row["Id"]; ?>" class="btn btn-dark">Seleccionar</a>
